    ...
    public class ZanoxCouponProfile : Profile
    {
        public ZanoxCouponProfile()
        {
            ...
            CreateMap<IncentiveItem, AffiliateCoupon>()
                ...
                .ForMember(dest => dest.Description, map => map.MapFrom(source => string.IsNullOrWhiteSpace(source.Admedia.Items.FirstOrDefault().Description) ? source.Name : source.Admedia.Items.FirstOrDefault().Description))
